                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            if (!empty($search)) {
                                ...
                                $sql = "SELECT * FROM bookings WHERE status='Approved' LIMIT $offset, $limit";
                            }
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td>
                                            <form method="post" action="">
                                                ...
                                                <button type="submit" name="action" value="checkin" class="approve-btn">CheckIn</button>
                                                <button type="submit" name="action" value="checkout" class="cancel-btn">Cancel</button>
                                            </form>
                                          </td>';
                                    echo "</tr>";
                                }
                              ...
                              if (!empty($search)) {
                                ...
                                $count_sql = "SELECT COUNT(id) AS total FROM bookings WHERE status = 'Approved'";
                            }
